...
```sh
npm install @titan-design/style-profile
```

Status: placeholder. Tracked by TP-131. Replace every section below before the package
ships its first real release.

## The problem it solves

Declare one code-style profile and export it as enforcement artifacts: ESLint and ruff configs, EditorConfig, Claude rules, hooks, a skill, and markdown
...
```ts
import {} from "@titan-design/style-profile";
```
