...
```sh
npm install @titan-design/code-parser
```

Status: placeholder. Tracked by TP-125. Replace every section below before the package
ships its first real release.

## The problem it solves

Tree-sitter WASM parsing for TypeScript, TSX and Python, plus the source-file filter and the Extractor contract
...
```ts
import {} from "@titan-design/code-parser";
```
