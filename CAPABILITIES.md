...
[where code goes](https://hjewkes.github.io/titan-platform/guides/where-code-goes)). Then check the runtime paths: the credential a
...
- +10 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/agent-protocol)
...
- +59 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/chat-protocol)
...
- `clusterer`: `Clusterer`
- +13 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/cluster)
...
### [`embed`](https://hjewkes.github.io/titan-platform/reference/embed)
...
- `seeded`: `seededRandom`
- +12 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/evidence)

<a id="cap-locator"></a>

### [`locator`](https://hjewkes.github.io/titan-platform/reference/locator)
...
- +11 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/locator)
...
- +74 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/agent)
...
- +29 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/matrix-bus)
...
- +26 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/registry)
...
- +23 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/retrieval)
...
- +67 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/memory)
...
- +36 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/style-analyzer)
...
- +50 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/workflow)
...
- +1 more in the [reference page](https://hjewkes.github.io/titan-platform/reference/react-app)
